...
export function TelaDeVerificacaoDeEmail({ cliente }: PropsDaTela) {
  ...
  // O fragmento é a origem real; a query string fica como caminho alternativo
  // para quem testar o link colando ?token= manualmente.
  ...
  useEffect(() => {
    ...
    // O token sai da barra de endereços antes da chamada: mantido ali, ele
    // acompanha o histórico do navegador e vaza em cabeçalhos de referência
    // para qualquer recurso que a página venha a carregar.
